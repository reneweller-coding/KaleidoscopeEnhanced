...
#include "CombineEffectKaleidoscope.h"
...
// Constructor
CombineEffectKaleidoscope::CombineEffectKaleidoscope(): 
m_minSides(2)
, m_maxSides(14)
, m_speedAct(0.01)
, m_speed(0.02)
...
void CombineEffectKaleidoscope::setUniforms( float time, float interpolation, GLint texLoc1, GLint texLoc2 )
{
 ...
 */
void CombineEffectKaleidoscope::initUniforms(int width, int height)
{	
...
void CombineEffectKaleidoscope::resetParameters()
{

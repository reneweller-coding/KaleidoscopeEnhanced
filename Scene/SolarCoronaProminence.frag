...
void main() {
    ...
    vec3 granColor = palTint(mix(vec3(0.9, 0.3, 0.05), vec3(1.0, 0.85, 0.3), granuleLuminance), 0.10 * granuleLuminance, 0.18);
    vec3 loopColor = palTint(mix(vec3(1.0, 0.2, 0.5), vec3(1.0, 0.95, 0.7), loopAccum * 0.4), 0.50, 0.18);

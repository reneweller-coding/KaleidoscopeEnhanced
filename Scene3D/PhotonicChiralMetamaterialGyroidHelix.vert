...
void main()
{
    ...
    float zPos = (tCoord - 0.5) * 3.4;
    float phi = tCoord * nTurns * 6.2831853 + rIndex * 0.31415927 + t * 1.5;
    ...
    vec3 tangent = normalize(vec3(-sin(phi) * hRad * nTurns * 6.2831853, cos(phi) * hRad * nTurns * 6.2831853, 3.4));

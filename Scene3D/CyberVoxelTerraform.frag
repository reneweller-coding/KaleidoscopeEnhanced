...
void main() {
    ...
    vec3 heightColor = mix(vec3(0.05, 0.2, 0.4), vec3(0.0, 1.0, 0.7), clamp(vHeight / 2.5, 0.0, 1.0));
    ...
    vec3 neonRim = mix(vec3(0.0, 0.9, 1.0), vec3(1.0, 0.9, 0.2), topFace) * neo * (0.8 + audioKick * 2.0);

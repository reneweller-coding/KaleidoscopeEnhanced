...
void main() {
    ...
    vec3 torusColor = 0.5 + 0.5 * cos(vec3(0.0, 2.0, 4.0) + vIndex * 6.28 + audioPhase);
    ...
    vec3 col = mix(photo, torusColor, 0.45);
    col = col * (0.4 + 0.6 * diff) + spec * vec3(1.0, 0.95, 0.8) * (1.0 + audioKick * 2.0);

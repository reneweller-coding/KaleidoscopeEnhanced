...
enum StrId
{
	...
	S_SETUP_IMAGEDIR, S_SETUP_IMAGEDIR_DEFAULT, S_SETUP_IMAGEDIR_PICK,
	S_SETUP_IMAGEDIR_HINT,
	S_SETUP_GROUP_PACKS, S_SETUP_PACKS_HINT,
	S_SETUP_PACK_IMAGES, S_SETUP_PACK_SHIPS, S_SETUP_PACK_STATIONS, S_SETUP_PACK_OBJECTS,
	S_SETUP_PACK_INSTALLED, S_SETUP_PACK_GET, S_SETUP_PACK_CANCEL,
	S_SETUP_PACK_DOWNLOADING, S_SETUP_PACK_EXTRACTING, S_SETUP_PACK_DONE,
	S_SETUP_PACK_FAILED, S_SETUP_PACK_CANCELLED, S_SETUP_PACK_NOSPACE,
	...
	S_WR_VERSION, S_WR_INSTALLUPDATE, S_WR_UPDATEHINT,
	S_SETUP_UPDATECHECK, S_SETUP_UPDATECHECK_HINT,

...
const char *kDE[S_COUNT] = {
	...
	/* S_SETUP_IMAGEDIR */        "Bilderordner:",
	/* S_SETUP_IMAGEDIR_DEFAULT */ "(mitgelieferte Bilder)",
	/* S_SETUP_IMAGEDIR_PICK */   "Durchsuchen ...",
	/* S_SETUP_IMAGEDIR_HINT */   "Leer lassen fuer die mitgelieferten Bilder. Unterordner werden mitdurchsucht (JPG, JPEG, PNG).",
	/* S_SETUP_GROUP_PACKS */    "Zusatzinhalte herunterladen",
	/* S_SETUP_PACKS_HINT */     "Bilder und 3D-Modelle sind nicht im Installer enthalten. Hier werden sie geladen und direkt in die richtigen Ordner entpackt.",
	/* S_SETUP_PACK_IMAGES */    "Bilder (1000 Texturen)",
	/* S_SETUP_PACK_SHIPS */     "3D: Raumschiffe (79)",
	/* S_SETUP_PACK_STATIONS */  "3D: Stationen (30)",
	/* S_SETUP_PACK_OBJECTS */   "3D: Objekte (48)",
	/* S_SETUP_PACK_INSTALLED */ "bereits installiert",
	/* S_SETUP_PACK_GET */       "Herunterladen und installieren",
	/* S_SETUP_PACK_CANCEL */    "Abbrechen",
	/* S_SETUP_PACK_DOWNLOADING */ "Lade",
	/* S_SETUP_PACK_EXTRACTING */  "Entpacke",
	/* S_SETUP_PACK_DONE */      "Fertig. Beim naechsten Start des Visualizers sind die Inhalte da.",
	/* S_SETUP_PACK_FAILED */    "Fehlgeschlagen:",
	/* S_SETUP_PACK_CANCELLED */ "Abgebrochen.",
	/* S_SETUP_PACK_NOSPACE */   "Zu wenig freier Speicherplatz auf dem Ziellaufwerk.",
	...
	/* S_WR_TAB_LIVE */           "Live",
	/* S_WR_TAB_PRESETS */        "Presets",
	/* S_WR_TAB_CAPTURE */        "Aufnahme",
	/* S_WR_TAB_DISPLAY */        "Anzeige",
	/* S_WR_TAB_IMAGE */          "Bild & 3D",
	/* S_WR_TAB_INFO */           "Info",
	/* S_WR_FREEZE */             "Einfrieren",
	/* S_WR_PIN */                "Effekt anheften",
	/* S_WR_TAPTEMPO */           "Tap-Tempo",
	/* S_WR_RECORD_START */       "Aufnahme starten",
	/* S_WR_RECORD_STOP */        "Aufnahme stoppen",
	/* S_WR_SCREENSHOT */         "Screenshot (PNG)",
	/* S_WR_SHADERNAMES */        "Shader-Namen einblenden",
	/* S_WR_FEATUREOVERLAY */     "Audio-Analyse einblenden",
	/* S_WR_STEREOMODE */         "Stereo-3D",
	/* S_WR_STEREODEPTH */        "Stereo-Tiefe",
	/* S_WR_RENDERSCALE */        "Bildskalierung",
	/* S_WR_SAVEDEFAULTS */       "Als Standard speichern",
	/* S_WR_ACTIVE_PRESET */      "Aktives Preset",
...
const char *kEN[S_COUNT] = {
	...
	/* S_SETUP_REMOTEPORT */      "Web remote port:",
	/* S_SETUP_IMAGEDIR */        "Photo folder:",
	/* S_SETUP_IMAGEDIR_DEFAULT */ "(bundled images)",
	/* S_SETUP_IMAGEDIR_PICK */   "Browse ...",
	/* S_SETUP_IMAGEDIR_HINT */   "Leave empty for the bundled images. Subfolders are searched too (JPG, JPEG, PNG).",
	/* S_SETUP_GROUP_PACKS */    "Download extra content",
	/* S_SETUP_PACKS_HINT */     "The images and 3D models are not in the installer. This fetches them and unpacks them straight into the right folders.",
	/* S_SETUP_PACK_IMAGES */    "Photos (1000 textures)",
	/* S_SETUP_PACK_SHIPS */     "3D: ships (79)",
	/* S_SETUP_PACK_STATIONS */  "3D: stations (30)",
	/* S_SETUP_PACK_OBJECTS */   "3D: objects (48)",
	/* S_SETUP_PACK_INSTALLED */ "already installed",
	/* S_SETUP_PACK_GET */       "Download and install",
	/* S_SETUP_PACK_CANCEL */    "Cancel",
	/* S_SETUP_PACK_DOWNLOADING */ "Downloading",
	/* S_SETUP_PACK_EXTRACTING */  "Extracting",
	/* S_SETUP_PACK_DONE */      "Done. The content is there the next time the visualizer starts.",
	/* S_SETUP_PACK_FAILED */    "Failed:",
	/* S_SETUP_PACK_CANCELLED */ "Cancelled.",
	/* S_SETUP_PACK_NOSPACE */   "Not enough free space on the target drive.",
	...
	/* S_WR_TAB_LIVE */           "Live",
	/* S_WR_TAB_PRESETS */        "Presets",
	/* S_WR_TAB_CAPTURE */        "Capture",
	/* S_WR_TAB_DISPLAY */        "Display",
	/* S_WR_TAB_IMAGE */          "Image & 3D",
	/* S_WR_TAB_INFO */           "Info",
	/* S_WR_FREEZE */             "Freeze",
	/* S_WR_PIN */                "Pin effect",
	/* S_WR_TAPTEMPO */           "Tap tempo",
	/* S_WR_RECORD_START */       "Start recording",
	/* S_WR_RECORD_STOP */        "Stop recording",
	/* S_WR_SCREENSHOT */         "Screenshot (PNG)",
	/* S_WR_SHADERNAMES */        "Show shader names",
	/* S_WR_FEATUREOVERLAY */     "Show audio analysis",
	/* S_WR_STEREOMODE */         "Stereo 3D",
	/* S_WR_STEREODEPTH */        "Stereo depth",
	/* S_WR_RENDERSCALE */        "Render scale",
	/* S_WR_SAVEDEFAULTS */       "Save as default",
	/* S_WR_ACTIVE_PRESET */      "Active preset",

...
const char *kDE[S_COUNT] = {
	...
	/* S_SETUP_VIDEOCODEC */      "Aufnahme-Codec:",
	/* S_SETUP_CODEC_HINT */      "H.264 spielt überall. HEVC ist bei gleicher Qualität rund 2,5-mal kleiner, braucht unter Windows aber die HEVC-Erweiterung. AV1 ist auf NVIDIA-Karten HEVC unterlegen.",
	/* S_HELP_SPACE */            "Szene markieren / Markierung loesen",
	/* S_HELP_SHIFT_SPACE */      "alle markierten Szenen als Marked-Preset speichern",
	/* S_WR_MARK */               "Markieren",
	/* S_WR_SAVEMARKED */         "Marked speichern",
	/* S_MENU_CONFIG_TITLE */     "Preset wählen",
	/* S_MENU_NAV_HINT */         "↑↓ blättern    Enter wählen    Tippen filtert    Esc schließen",
	/* S_MENU_NO_MATCH */         "kein Treffer",
	...
	/* S_SETUP_MOTIONBLUR */      "Bewegungsunschaerfe in Aufnahmen",
	/* S_SETUP_MOTIONBLUR_HINT */ "Mittelt die Bilder, die zwischen zwei Aufnahme-Bildern ohnehin gerendert und verworfen werden. Kostet keine zusaetzliche Rechenzeit fuers Rendern und veraendert die Helligkeit nicht.",
	/* S_SETUP_SHOWHIDDEN */      "Debug: versteckte Presets einblenden",
	/* S_SETUP_SHOWHIDDEN_HINT */ "Zeigt Komplett und die Test-Presets im Menue, auf den Zifferntasten und in der Fernbedienung. Normalerweise ausgeblendet, weil sie Referenz und Pruefstand sind und nicht zum Zuschauen gedacht.",
	/* S_SETUP_OSCPORT */         "OSC-Ausgabe (Port, 0 = aus):",
	/* S_SETUP_OSCHOST */         "OSC-Ziel (Host):",
	/* S_SETUP_OSC_HINT */        "Sendet die Analyse als OSC/UDP an VJ-Software (TouchDesigner, Resolume, Max): /mood/valence, /mood/arousal, /mood/quadrant, /beat, /audio/bands, /tempo/bpm. Details in docs/mood-and-mapping.md.",
...
const char *kEN[S_COUNT] = {
	...
	/* S_SETUP_VIDEOCODEC */      "Recording codec:",
	/* S_SETUP_CODEC_HINT */      "H.264 plays everywhere. HEVC is about 2.5x smaller at the same quality but needs the HEVC extension on Windows. AV1 loses to HEVC on NVIDIA cards.",
	/* S_HELP_SPACE */            "mark / unmark this scene",
	/* S_HELP_SHIFT_SPACE */      "save all marked scenes as the Marked preset",
	/* S_WR_MARK */               "Mark",
	/* S_WR_SAVEMARKED */         "Save marked",
	/* S_MENU_CONFIG_TITLE */     "Choose preset",
	/* S_MENU_NAV_HINT */         "↑↓ scroll    Enter select    type to filter    Esc close",
	/* S_MENU_NO_MATCH */         "no match",
	...
	/* S_SETUP_MOTIONBLUR */      "Motion blur in recordings",
	/* S_SETUP_MOTIONBLUR_HINT */ "Averages the frames that are rendered and thrown away between captures anyway. Costs no extra rendering and does not change exposure.",
	/* S_SETUP_SHOWHIDDEN */      "Debug: show hidden presets",
	/* S_SETUP_SHOWHIDDEN_HINT */ "Puts Komplett and the Test presets back in the menu, on the digit keys and in the remote. Hidden by default because they are a reference and an inspection bench, not something to watch.",
	/* S_SETUP_OSCPORT */         "OSC output (port, 0 = off):",
	/* S_SETUP_OSCHOST */         "OSC target (host):",
	/* S_SETUP_OSC_HINT */        "Streams the analysis as OSC/UDP to VJ software (TouchDesigner, Resolume, Max): /mood/valence, /mood/arousal, /mood/quadrant, /beat, /audio/bands, /tempo/bpm. Details in docs/mood-and-mapping.md.",
	/* S_SETUP_SAVE */            "Save",
	/* S_SETUP_CLOSE */           "Close",

...
// same transition-style library as CombinePlain.frag (host-rolled transStyle;
// 0/absent = classic linear mix; see CombinePlain.frag for the style list).
// interpolation: 1 = old (tex0) .. 0 = new (tex1).
